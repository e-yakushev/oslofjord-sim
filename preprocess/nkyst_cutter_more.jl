...
# Define spatial subregion
    ...
    #xlim = (384000, 409000) # Drammensfjorden from Outer Oslofjord
    #ylim = (134000, 160000)  # Drammensfjorden from Outer Oslofjord
...
while current_date <= end_date
    ...
    #    infile  = joinpath(folder, filename)
        ...
        outfile = joinpath(homedir(),"FjordSim_data", "oslofjord", "NorKyst2", "NKz_$date_of_file.nc")
