...
for date_of_file in 2020022900:100:2020022900
...
#    infile  = joinpath(folder, filename)
    infile  = joinpath(homedir(),"src", "oslofjord-sim","preprocess", filename)
    println("Input file: $infile")
    outfile = joinpath(homedir(),"FjordSim_data", "oslofjord", "NorKyst", "NKz_800m_$date_of_file.nc")
